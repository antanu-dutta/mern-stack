...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <div className="hidden md:block w-[40vw] h-sreen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-center overflow-hidden p-8 relative">
...
const StarsInfoCard = ({ icon, label, color, value }) => {
  return (
    <div className="flex relative gap-6 bg-white p-4 rounded-xl shadow-purple-400/10 border border-gray-250">
      <div
